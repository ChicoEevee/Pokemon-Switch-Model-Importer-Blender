...
def DynamicFloatTrackAddValue(builder, value):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(value), 0)

def AddValue(builder, value):
    DynamicFloatTrackAddValue(builder, value)

def DynamicFloatTrackStartValueVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartValueVector(builder, numElems: int) -> int:
    return DynamicFloatTrackStartValueVector(builder, numElems)
